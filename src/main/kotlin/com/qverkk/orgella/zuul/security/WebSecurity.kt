...
class WebSecurity(private val env: Environment) : WebSecurityConfigurerAdapter() {
    ...
    override fun configure(http: HttpSecurity) {
        ...
        http.authorizeRequests()
            ...
            .antMatchers(HttpMethod.GET, env.getProperty("api.auctions.find.url.path")).permitAll()
            .antMatchers(HttpMethod.GET, env.getProperty("api.auctions.details.url.path")).permitAll()
            .antMatchers(HttpMethod.GET, env.getProperty("api.auctions.reviews.url.path")).permitAll()
